<?php
   ...
   // gets user id for a particular session 
   $session = $_SESSION["uid"];
   
   // gets all stocks and number of shares for a user and their total cash
  ...
  <body>
    ...
    <div id="middle">
      ...
      <?php
        ...
        // prints out all shares in users portfolio          
        ...
        // for determining total cash a user has
